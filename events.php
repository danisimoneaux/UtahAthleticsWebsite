  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h5 class="fw-light">Events</h5>
        <p class="lead text-muted"> Welcome to the Events Page! You can view events and purchase tickets to any upcoming events below</p>
      </div>
    </div>
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h5 class="fw-light">Upcoming Events</h5>
        <p class="lead text-muted">Welcome to Utes Events Page! You can view events and purchase tickets to any upcoming events below</p>
        <p>
        </p>
      </div>
    </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">2022 Soccer Season</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">View Details</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">Buy Tickets</button>
                </div>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <a href="homepage.html"> <img src="download.png" width="100%" height="225%"> </img></a>
            <div class="card-body">
              <p class="card-text">2022 Softball Diamond Club</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">View Details</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">Buy Tickets</button>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <a href="homepage.html"> <img src="download.png" width="100%" height="225%"> </img></a>
            <div class="card-body">
              <p class="card-text">2022 Utah Gymnastics</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">View Details</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">Buy Tickets</button>
