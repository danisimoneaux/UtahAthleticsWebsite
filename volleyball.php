  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h5 class="fw-light">Utah Volleyball</h5>
        <p class="lead text-muted"> Welcome to Utah Volleyball's Page! You can view events and purchase tickets to any upcoming events below</p>
      </div>
    </div>
  </section>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">2022 Tickets</p>
              <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted">Huntsman</small>
              </div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">2022 VIP Tickets</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <form method="get" action="https://am.ticketmaster.com/utahutes/">
                  <button type="submit" class="btn btn-sm btn-outline-secondary">View Details</button>
