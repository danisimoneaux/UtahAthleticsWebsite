<html>
  ...
  <h2>
    Add Your Athletes Personal Records Here
  </h2>
    ...
    echo <<<_END
    <pre>
      <a href="../AthletePages/athletepr.php">Add Record</a>
    ...
    echo <<<_END
        ...
        <form action="../deleteEntry1.php" method="post">
