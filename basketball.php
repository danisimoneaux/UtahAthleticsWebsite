  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h5 class="fw-light">Utah Basketball</h5>
        <p class="lead text-muted"> Welcome to Utah Basketball's Page! You can view events and purchase tickets to any upcoming events below</p>
      </div>
    </div>
  </section>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <a href="homepage.php"> <img src="download.png" width="100%" height="225%"> </img></a>
            <div class="card-body">
